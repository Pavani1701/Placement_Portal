...
window.addEventListener('DOMContentLoaded', () => {
  fetch('https://srv-d16bhfumcj7s73bvhlug.onrender.com/api/jobs')
...
document.getElementById('applicationForm').addEventListener('submit', function (e) {
  ...
  fetch('https://srv-d16bhfumcj7s73bvhlug.onrender.com/api/jobs/apply', {
    method: 'POST',
    headers: {
...
document.getElementById('jobForm').addEventListener('submit', function (e) {
  ...
  fetch('https://srv-d16bhfumcj7s73bvhlug.onrender.com/api/jobs/create', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
...
console.log("Email:", email, "Password:", password);
  fetch('https://srv-d16bhfumcj7s73bvhlug.onrender.com/api/auth/admin-login', {
    method: 'POST',
...
function deleteJob(jobId) {
  ...
  fetch(`https://srv-d16bhfumcj7s73bvhlug.onrender.com/api/jobs/${jobId}`, {
  method: 'DELETE'
})
.then(res => res.json())
.then(data => {
...
function loadApplications() {
  fetch('https://srv-d16bhfumcj7s73bvhlug.onrender.com/api/applications')
    .then(res => res.json())
    .then(applications => {
